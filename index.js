...
// create array of licenses names from the licenses array to use in the inquirer licenses list
const licenseArr = Object.entries(licenses);

const licenseNames = [];

for (let i = 0; i < licenseArr.length; i++) {
    let name = licenseArr[i][1].name;
